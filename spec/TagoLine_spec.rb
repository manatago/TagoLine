...
RSpec.describe TagoLine do
  ...
  it "has a callback_url" do
    expect(TagoLine::CALLBACK_URL).not_to be nil
  end

  it "has a channel_id" do
    expect(TagoLine::CHANNEL_ID).not_to be nil
  end

  it "has a channel_secret" do
    expect(TagoLine::CHANNEL_SECRET).not_to be nil
  end
